 ...
 *
 * Plugin Command:
 *   ItemBook bookOpen        # Open the gacha book screen
 *   ItemBook add weapon 3    # Add weapon #3 to the gacha book
 *   ItemBook add armor 4     # Add armor #4 to the gacha book
 *   ItemBook remove armor 5  # Remove armor #5 from the gacha book
 *   ItemBook remove item 6   # Remove item #6 from the gacha book
 ...
 *
 * @param Simple Display
 * @desc trueと入力すると詳細表示が名前と概要だけになります。
 * @default
 *
 * @help
 *
 * Plugin Command:
 *   ItemBook bookOpen        # ガチャブックを開きます
 *   ItemBook add weapon 3    # 武器３番をガチャブックに追加
 *   ItemBook add armor 4     # 防具4番をガチャブックに追加
 *   ItemBook remove armor 5  # 防具5番をガチャブックから削除
 *   ItemBook remove item 6   # アイテム6番をガチャブックから削除
 *   ItemBook clear           # ガチャブックをクリアする
 */
...
(function() {
    ...
    var simpleDisplay = Boolean(parameters['Simple Display'] || '');
