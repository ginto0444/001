 ...
 *
 * @param Rank1 Effect
 * @desc The animation number for rank 1 effect.
 * @default -1
 *
 * @param Rank2 Effect
 * @desc The animation number for rank 2 effect.
 * @default -1
 *
 * @param Rank3 Effect
 * @desc The animation number for rank 3 effect.
 * @default -1
 *
 * @param Rank4 Effect
 * @desc The animation number for rank 4 effect.
 * @default -1
 *
 * @param Rank5 Effect
 * @desc The animation number for rank 5 effect.
 * @default -1
 *
 * @param ME
 ...
 *
 * Item Note:
 *   <gachaImage: image>        # Gacha image file name.
 ...
 *
 * @param Show Item Description
 * @desc trueでアイテム取得時に概要を表示します。
 * @default
 *
 * @param Effect
 * @desc アイテム取得時のアニメーション番号を指定します。
 * @default 119
 *
 * @param Rank1 Effect
 * @desc ランク1の時のアニメーション番号を指定します。
 * @default -1
 *
 * @param Rank2 Effect
 * @desc ランク2の時のアニメーション番号を指定します。
 * @default -1
 *
 * @param Rank3 Effect
 * @desc ランク3の時のアニメーション番号を指定します。
 * @default -1
 *
 * @param Rank4 Effect
 * @desc ランク4の時のアニメーション番号を指定します。
 * @default -1
 *
 * @param Rank5 Effect
 * @desc ランク5の時のアニメーション番号を指定します。
 * @default -1
 *
 * @param ME
 ...
 *
 * Item Note:
 *   <gachaImage: image>        # ガチャアイテムの画像を指定します。
...
(function () {
    ...
    var itemDescEnable = Boolean(parameters['Show Item Description'] || '');
